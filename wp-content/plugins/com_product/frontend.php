...
class Frontend{	
	...
	public function load_template($templates){
		...
		if(get_query_var('za_meal') != ''){
			$file = PLUGIN_PATH  . "templates" . DS . "frontend" . DS . 'za-meal.php';
			if(file_exists($file)){
				return $file;
			}	
		}
		if(get_query_var('zameal') != ''){					
			$file = PLUGIN_PATH  . "templates" . DS . "frontend" . DS . 'zameal.php';
			if(file_exists($file)){			
				return $file;
			}
		}
